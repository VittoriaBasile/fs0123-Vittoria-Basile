...
let obj = { name: "Leia Organa", hair_color: "brown", eye_color: "brown" };
...
for( let personaggio of starWarsCharacters) {
    ...
    while (i < starWarsCharacters.length) {
      massa += parseInt(personaggio.mass);
...
console.log('svolto con switch case');
...
console.log('svolto con if-else if');

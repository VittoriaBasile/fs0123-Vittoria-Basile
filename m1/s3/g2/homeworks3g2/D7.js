...
function conc(array1, array2) {
  let concatenamento = (array1.slice(0,2).concat(array2.slice( array2.length -3, array2.length)));

console.log(concatenamento);

console.log(concatenamento.toUpperCase());

}

 conc(stringa1, stringa2);
...
let numeriAdd1 = numeri.map(function(a){
  return a + 1;

})

console.log(numeriAdd1);
...
let frase = ["vieni","a","ballare","in","Puglia"];
